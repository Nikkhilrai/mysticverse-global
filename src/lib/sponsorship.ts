...
export const TIERS: readonly Tier[] = [
  {
    ...
    vipMedia:
      "Ownership of the MysticVerse Global Excellence Awards — presenting the flagship Celestial Impact Award on stage. Priority access to the Principals Lounge and the Wellness Investor Circle, delegate passes for your senior team, and first refusal on the following edition.",
    branding:
  ...
  },
  {
    ...
    vipMedia:
      "Host status at the Sunset Networking finale, held off-site at a single luxury property. Curated introductions to private-wealth delegates and investor-circle members, plus a full delegate allocation for your sales team.",
    branding:
  ...
  },
  {
    ...
    vipMedia:
      "Curated introductions to private-wealth delegates and the Wellness Investor Circle. Delegate passes for your clinical and commercial teams, and priority consideration for the Longevity Retreat of the Year category.",
    branding:
