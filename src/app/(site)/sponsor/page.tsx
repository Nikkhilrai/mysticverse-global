...
export const metadata: Metadata = {
  ...
  description:
    "Partner with the platform building the conscious luxury economy. Nine sponsorship tiers with curated access to real estate decision-makers, CHROs, longevity entrepreneurs, and investors. 11 September 2026, Dubai.",
  openGraph: {
