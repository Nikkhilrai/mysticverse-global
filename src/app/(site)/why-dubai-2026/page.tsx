...
export const metadata: Metadata = {
  alternates: { canonical: "/why-dubai-2026" },
  title: "Why Dubai 2026 | MysticVerse Global",
  description:
    "Dubai. By design. The geographic centre of the wellness real estate boom, three hours from a third of the world's population, and built for premium gatherings. Why MysticVerse Global 2026 is in Dubai.",
  openGraph: {
    title: "Why Dubai 2026 — MysticVerse Global",
    description:
