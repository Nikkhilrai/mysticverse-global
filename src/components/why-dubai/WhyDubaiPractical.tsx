...
const CARDS: Card[] = [
  ...
  },
  {
    ...
    points: [
      ...
      "Metro, taxi and chauffeur on tap; curated transfers for HNI guests.",
    ],
    icon: (
      <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
      ...
      <div className={styles.inner}>
        <header className={styles.head}>
          ...
          <h2 id="why-practical-heading" className={styles.heading}>
            Getting <span className="gradientText">here.</span>
          </h2>
          <p className={styles.sub}>
            Everything a delegate or an HNI guest needs to arrive without a
            second thought.
          </p>
        </header>
